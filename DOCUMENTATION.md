...
* **`style.css`**: тёмная тема по умолчанию, шрифт Outfit, макет сайдбар +
  контент, печать. Ниже 900 px сайдбар становится липкой верхней панелью,
  карта и панель анализа выстраиваются в одну колонку, карта занимает 60 %
  высоты экрана; ниже 1100 px карта и панель уже в одну колонку.
